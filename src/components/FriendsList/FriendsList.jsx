...
export default class FriendsList extends React.Component {
  ...
  const displayFriends = this.state.order === "ascending" ? friendsList: friendsList.reverse();
      ...
      <div>
          <form className="form-inline searchForm" role="form">
              <div className="form-group">
                  ...
                  <input
                      className="form-control" onChange={this.handleChange.bind(this, "searchText")} placeholder="Search For Friends"
